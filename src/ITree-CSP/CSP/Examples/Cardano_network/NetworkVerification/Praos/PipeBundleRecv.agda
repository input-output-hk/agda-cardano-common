...
module CSP.Examples.Cardano_network.NetworkVerification.Praos.PipeBundleRecv (blkA : Block₃) where
...
open import CSP.Examples.Cardano_network.NetworkVerification.Praos.SysIoLink6 blkA using ( absBFc-ev-dir )
open import CSP.Examples.Cardano_network.NetworkVerification.Praos.PipeRecvSource blkA using

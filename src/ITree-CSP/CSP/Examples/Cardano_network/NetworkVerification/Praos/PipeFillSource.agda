...
module CSP.Examples.Cardano_network.NetworkVerification.Praos.PipeFillSource (blkA : Block₃) where
...
open import CSP.Examples.Cardano_network.NetworkVerification.Praos.SysIoLink5 blkA using ( Tbfs )
open import CSP.Examples.Cardano_network.NetworkVerification.Praos.SysDecode blkA using ( SysState )
...
PlIsBlk pl = CellHasBlk (SM.full pl)
  where import CSP.Examples.Cardano_network.NetworkVerification.Praos.SysMedium blkA as SM

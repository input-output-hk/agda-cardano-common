...
module CSP.Examples.Cardano_network.NetworkVerification.Praos.SysOracle_GapBDisj (blkA : Block₃) where
...
open import CSP.Examples.Cardano_network.NetworkVerification.Praos.SysOracle_PeerEvIo blkA public

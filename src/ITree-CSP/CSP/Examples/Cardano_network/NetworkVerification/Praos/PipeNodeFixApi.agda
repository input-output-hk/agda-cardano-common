...
module CSP.Examples.Cardano_network.NetworkVerification.Praos.PipeNodeFixApi (blkA : Block₃) where
...
open import CSP.Examples.Cardano_network.NetworkVerification.Praos.Walk blkA using
  ( μTot; μTot-adv-G1; μTot-adv-G2; breakBudget )

-- the nodeD D-phase report + the frozen node-A api peel (node A has no client)
open import CSP.Examples.Cardano_network.NetworkVerification.Praos.WalkDExpose blkA using
  ( DReport; dFix; dBD; dCD )
open import CSP.Examples.Cardano_network.NetworkVerification.Praos.WalkApiDrop blkA using
...
open import CSP.Examples.Cardano_network.NetworkVerification.Praos.PipeNodeFix blkA using
  ( ClientClass1; clFix; clAdv; AllClientClass )
open import CSP.Examples.Cardano_network.NetworkVerification.Praos.PipeExposeNode blkA using
  ( ClientAdv; adv-of )
-- the io-sync driver-fixity cone (τ-run substrate for the prod/relay classes)
open import CSP.Examples.Cardano_network.NetworkVerification.Praos.WalkConvNodeFix blkA using
...
open import CSP.Examples.Cardano_network.NetworkVerification.Praos.WalkPr blkA using
  ( TwoLegs; legBD; legCD )
import CSP.Examples.Cardano_network.NetworkVerification.Praos.PipeExposeNodeProd blkA as PPr
import CSP.Examples.Cardano_network.NetworkVerification.Praos.PipeExposeNodeRelay blkA as PRl

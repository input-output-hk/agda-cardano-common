...
module CSP.Examples.Cardano_network.NetworkVerification.Praos.WalkApiReach (blkA : Block₃) where
...
open import CSP.Examples.Cardano_network.NetworkVerification.Praos.WalkApiDrop blkA

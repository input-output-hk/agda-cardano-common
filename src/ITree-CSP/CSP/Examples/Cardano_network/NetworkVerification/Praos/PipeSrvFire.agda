...
module CSP.Examples.Cardano_network.NetworkVerification.Praos.PipeSrvFire (blkA : Block₃) where
...
open import CSP.Examples.Cardano_network.NetworkVerification.Praos.SysIoLink5 blkA
  using ( Tbfc )

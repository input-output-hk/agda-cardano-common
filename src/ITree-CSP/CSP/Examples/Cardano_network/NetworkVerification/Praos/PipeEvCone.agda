...
module CSP.Examples.Cardano_network.NetworkVerification.Praos.PipeEvCone (blkA : Block₃) where
...
open import CSP.Examples.Cardano_network.NetworkVerification.Praos.SysOracle blkA using
  ( ApiHasLink; ahlBF )
open import CSP.Examples.Cardano_network.NetworkVerification.Praos.SysIoLink6 blkA using
  ( absBundleG-api-no )

...
module CSP.Examples.Cardano_network.NetworkVerification.Praos.PipeNodeIoEvo (blkA : Block₃) where
...
open import CSP.Examples.Cardano_network.NetworkVerification.Praos.SysOracle_RouteLnLf blkA
  using ( noOffer→viewV )
open import CSP.Examples.Cardano_network.NetworkVerification.Praos.SysIoLink blkA
...
open import CSP.Examples.Cardano_network.NetworkVerification.Praos.SysIoLink2 blkA
  using ( nodeC-io-no-when-B; nodeD-io-no-when-B; nodeD-io-no-when-C
        ; nodeB-io-no-when-A; nodeC-io-no-when-A; nodeD-io-no-when-A )
open import CSP.Examples.Cardano_network.NetworkVerification.Praos.SysIoLink3 blkA
...
open import CSP.Examples.Cardano_network.NetworkVerification.Praos.PipeSrvInv blkA
  using ( upSrv; dnSrv )
open import CSP.Examples.Cardano_network.NetworkVerification.Praos.PipeBundleEvo blkA
  using ( BFsHasBlk )
open import CSP.Examples.Cardano_network.NetworkVerification.Praos.PipeBundleIoEvo blkA
...
CliIoCls l d bfc bfc′ e a = (bfc ≡ bfc′) ⊎ ((BFcHasBlk bfc′ → ⊥) ⊎ BlkReadAt l d e a)

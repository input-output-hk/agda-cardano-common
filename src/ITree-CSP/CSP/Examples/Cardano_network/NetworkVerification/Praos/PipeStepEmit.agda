...
module CSP.Examples.Cardano_network.NetworkVerification.Praos.PipeStepEmit (blkA : Block₃) where
...
import CSP.Examples.Cardano_network.NetworkVerification.Praos.PipeExpose blkA as PE

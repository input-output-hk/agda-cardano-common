...
module CSP.Examples.Cardano_network.NetworkVerification.Praos.PipeInvProd (blkA : Block₃) where
...
open import CSP.Examples.Cardano_network.NetworkVerification.Praos.PipeTauMed blkA

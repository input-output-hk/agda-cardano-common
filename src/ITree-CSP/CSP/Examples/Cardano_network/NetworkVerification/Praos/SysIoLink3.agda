...
module CSP.Examples.Cardano_network.NetworkVerification.Praos.SysIoLink3 (blkA : Block₃) where
...
open import CSP.Examples.Cardano_network.NetworkVerification.Praos.SysIoLink2 blkA public

...
module CSP.Examples.Cardano_network.NetworkVerification.Praos.SysOracle_RouteLnLf (blkA : Block₃) where
...
open import CSP.Examples.Cardano_network.NetworkVerification.Praos.SysOracle_RouteKaTs blkA public

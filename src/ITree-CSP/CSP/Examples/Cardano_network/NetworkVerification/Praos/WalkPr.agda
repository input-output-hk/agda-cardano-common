...
module CSP.Examples.Cardano_network.NetworkVerification.Praos.WalkPr (blkA : Block₃) where
...
open SN
  using ( ConsPh; cp0; cp1; cp2; cp3; cp4; cp5; cp6; cph; cons-BD; cons-CD )
...
DeliverSig r r′ {X} e a =
  Σ[ c ∈ TwoLegs ]
    ...
    × Σ[ b″ ∈ Block₃ ] evLabel X e a ≡ evLabel Block₃ (apiBF (linkOf c) hi recvBFBlock) b″ )

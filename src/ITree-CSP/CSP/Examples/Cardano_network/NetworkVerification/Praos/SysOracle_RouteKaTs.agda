...
module CSP.Examples.Cardano_network.NetworkVerification.Praos.SysOracle_RouteKaTs where
open import CSP.Examples.Cardano_network.NetworkVerification.Praos.SysOracle_GapBDisj public

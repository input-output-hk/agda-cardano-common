...
module CSP.Examples.Cardano_network.NetworkVerification.Praos.WalkDeliver (blkA : Block₃) where
...
open import CSP.Examples.Cardano_network.NetworkVerification.Praos.WalkTauExpose blkA
  using ( liftτ*-expose )
open import CSP.Examples.Cardano_network.NetworkVerification.Praos.WalkConvNoDiv blkA
  using ( absNoDiv )
import CSP.Examples.Cardano_network.NetworkVerification.Praos.WalkEnabled blkA as WEn
open WEn using ( IntactApiClass )
import CSP.Examples.Cardano_network.NetworkVerification.Praos.SysBisim blkA as SB
...
module _
  ...
  ...   | inj₂ (_ , _ , _ , _ , lbl)      = ⊥-elim (subst isRecvBF (sym lbl) U.tt)
  ...
  ... | r′ , eq , lt , drep with Pr-step b {r} {r′} pr drep
  ...   | inj₁ pr′                        = inj₂ (r′ , eq , lt , pr′)
  ...   | inj₂ (legBD , _ , _ , _ , refl) = inj₁ (inj₁ refl , refl)
  ...   | inj₂ (legCD , _ , _ , _ , refl) = inj₁ (inj₂ refl , refl)

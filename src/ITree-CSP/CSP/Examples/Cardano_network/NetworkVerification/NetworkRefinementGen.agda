...
inputAt  = (Data , input  fz lo N2N_KeepAlive)
outputAt = (Data , output fz lo N2N_KeepAlive)
txAt     = (Data , tx     fz lo N2N_KeepAlive)
...
sndmsgAtN = (Data , sndmsg fz lo N2N_KeepAlive)
rcvmsgAtN = (Data , rcvmsg fz lo N2N_KeepAlive)
txAtN     = txAt
outputAtN = outputAt
...
decT-T0-sndmsg : ∀ {d a W} →
  decT T0 d ─[ ev (evN (sndmsg fz lo N2N_KeepAlive) a) ]─► W → W ≡ decT T1 a
...
decT-T1-tx : ∀ {d a W} →
  decT T1 d ─[ ev (evN (tx fz lo N2N_KeepAlive) a) ]─► W → a ≡ d
...
decR-R0-ack : ∀ {d a W} →
  decR R0 d ─[ ev (evN (ack fz lo N2N_KeepAlive) a) ]─► W → W ≡ decR R1 d
...
decR-R1-rcvack : ∀ {d a W} →
  decR R1 d ─[ ev (evN (rcvack fz lo N2N_KeepAlive) a) ]─► W → W ≡ decR Rg d
...
decC-Rc0-tx : ∀ {d a W} →
  decC Rc0 d ─[ ev (evN (tx fz lo N2N_KeepAlive) a) ]─► W → W ≡ decC Rc1 a
...
decC-Rc1-rcvmsg : ∀ {d a W} →
  decC Rc1 d ─[ ev (evN (rcvmsg fz lo N2N_KeepAlive) a) ]─► W → a ≡ d
...
decS-Sa0-sndack : ∀ {d a W} →
  decS Sa0 d ─[ ev (evN (sndack fz lo N2N_KeepAlive) a) ]─► W → W ≡ decS Sa1 d
...
decS-Sa1-ack : ∀ {d a W} →
  decS Sa1 d ─[ ev (evN (ack fz lo N2N_KeepAlive) a) ]─► W → W ≡ decS Sag d
...
decI-I0-input : ∀ {d a W} →
  decI I0 d ─[ ev (evN (input fz lo N2N_KeepAlive) a) ]─► W → W ≡ decI I1 a
...
decI-I1-sndmsg : ∀ {d a W} →
  decI I1 d ─[ ev (evN (sndmsg fz lo N2N_KeepAlive) a) ]─► W → a ≡ d
...
decI-I2-rcvack : ∀ {d a W} →
  decI I2 d ─[ ev (evN (rcvack fz lo N2N_KeepAlive) a) ]─► W → W ≡ decI Ig d
...
decO-O0-rcvmsg : ∀ {d a W} →
  decO O0 d ─[ ev (evN (rcvmsg fz lo N2N_KeepAlive) a) ]─► W → W ≡ decO O1 a
...
decO-O1-output : ∀ {d a W} →
  decO O1 d ─[ ev (evN (output′ fz lo N2N_KeepAlive) a) ]─► W → a ≡ d
...
decO-O2-sndack : ∀ {d a W} →
  decO O2 d ─[ ev (evN (sndack fz lo N2N_KeepAlive) a) ]─► W → W ≡ decO Og d
...
inputLbl  a = evl (evLabel Data (input  fz lo N2N_KeepAlive) a)
outputLbl a = evl (evLabel Data (output fz lo N2N_KeepAlive) a)
txLbl     a = evl (evLabel Data (tx     fz lo N2N_KeepAlive) a)

-- generalized tx label (any dir,id + payload), pinned Event√ NetR.
txLbl-at : Dir → IDs → Data → Event√ NetR
txLbl-at dr id a = evl (evLabel Data (tx fz dr id) a)

ackLbl : Event√ NetR
ackLbl = evl (evLabel ⊤ (ack fz lo N2N_KeepAlive) tt)

-- generalized ack label (any dir,id), pinned Event√ NetR (evl's R fixed).
ackLbl-at : Dir → IDs → Event√ NetR
ackLbl-at dr id = evl (evLabel ⊤ (ack fz dr id) tt)
...
decI-sndmsg-class : ∀ {i d a W} →
  decI i d ─[ ev (evN (sndmsg fz lo N2N_KeepAlive) a) ]─► W →
...
decI-rcvack-class : ∀ {i d a W} →
  decI i d ─[ ev (evN (rcvack fz lo N2N_KeepAlive) a) ]─► W → (i ≡ I2) × (W ≡ decI Ig d)
...
decT-sndmsg-class : ∀ {t d a W} →
  decT t d ─[ ev (evN (sndmsg fz lo N2N_KeepAlive) a) ]─► W → (t ≡ T0) × (W ≡ decT T1 a)
...
decT-no-rcvack : ∀ {t d a W dr id} →
  decT t d ─[ ev (evN (rcvack fz dr id) a) ]─► W → ⊥
...
decR-rcvack-class : ∀ {r d a W} →
  decR r d ─[ ev (evN (rcvack fz lo N2N_KeepAlive) a) ]─► W → (r ≡ R1) × (W ≡ decR Rg d)
...
decR-no-sndmsg : ∀ {r d a W dr id} →
  decR r d ─[ ev (evN (sndmsg fz dr id) a) ]─► W → ⊥
...
TR-sndmsg-class : ∀ {t r d a W} →
  (decT t d ⦀ decR r d) ─[ ev (evN (sndmsg fz lo N2N_KeepAlive) a) ]─► W →
...
TR-rcvack-class : ∀ {t r d a W} →
  (decT t d ⦀ decR r d) ─[ ev (evN (rcvack fz lo N2N_KeepAlive) a) ]─► W →
...
-- Off-instance (dir,id) pinning for the csSR sync channels (payload-agnostic).
decI-sndmsg-pins : ∀ {i d a W dr id} →
  decI i d ─[ ev (evN (sndmsg fz dr id) a) ]─► W → (dr ≡ lo) × (id ≡ N2N_KeepAlive)
decI-sndmsg-pins {I0} (sVis refl ())
decI-sndmsg-pins {I1} {d} {a} {W} {dr} {id} (sVis refl br)
  with Net-≟ {Data} (Data , sndmsg fz lo N2N_KeepAlive) (Data , sndmsg fz dr id) | br
... | yes refl | _  = refl , refl
... | no  _    | ()
decI-sndmsg-pins {I2} {d = d} step rewrite ≟-diag d with step
... | sVis refl h = nothing-absurd h
decI-sndmsg-pins {Ig} {d} step = ⊥-elim (decI-Ig-noev {d} step)

decI-rcvack-pins : ∀ {i d a W dr id} →
  decI i d ─[ ev (evN (rcvack fz dr id) a) ]─► W → (dr ≡ lo) × (id ≡ N2N_KeepAlive)
decI-rcvack-pins {I0} (sVis refl ())
decI-rcvack-pins {I1} (sVis refl ())
decI-rcvack-pins {I2} {d = d} {dr = dr} {id = id} step rewrite ≟-diag d with step
... | sVis refl br
      with Net-≟ {Data} (⊤ , rcvack fz lo N2N_KeepAlive) (⊤ , rcvack fz dr id) | br
...   | yes refl | _  = refl , refl
...   | no  _    | ()
decI-rcvack-pins {Ig} {d} step = ⊥-elim (decI-Ig-noev {d} step)
...
... | sndmsg fz dr id with dr ≟ lo | id ≟ N2N_KeepAlive
...   | yes refl | yes refl
...
sim-Tx-τ {i} {t} {r} {d} step | hτH {B} {e} {a} _ mem parev refl | sndmsg fz dr id | yes refl | yes refl
      | evL  ¬cs _   = ⊥-elim (¬cs mem)
sim-Tx-τ {i} {t} {r} {d} step | hτH {B} {e} {a} _ mem parev refl | sndmsg fz dr id | yes refl | yes refl
      | evR  ¬cs _   = ⊥-elim (¬cs mem)
sim-Tx-τ {i} {t} {r} {d} step | hτH {B} {e} {a} _ mem parev refl | sndmsg fz dr id | yes refl | yes refl
      | evBoth ¬cs _ _ = ⊥-elim (¬cs mem)
sim-Tx-τ {i} {t} {r} {d} step | hτH {B} {e} {a} _ mem parev refl | sndmsg fz dr id | no ¬dr | _
      with Par-ev-elim csSR' ⊤merge (decI i d) (decT t d ⦀ decR r d) parev
...   | evSync _ Iev _  = ⊥-elim (¬dr (proj₁ (decI-sndmsg-pins {i} Iev)))
...   | evL  ¬cs _      = ⊥-elim (¬cs mem)
...   | evR  ¬cs _      = ⊥-elim (¬cs mem)
...   | evBoth ¬cs _ _  = ⊥-elim (¬cs mem)
sim-Tx-τ {i} {t} {r} {d} step | hτH {B} {e} {a} _ mem parev refl | sndmsg fz dr id | yes refl | no ¬id
      with Par-ev-elim csSR' ⊤merge (decI i d) (decT t d ⦀ decR r d) parev
...   | evSync _ Iev _  = ⊥-elim (¬id (proj₂ (decI-sndmsg-pins {i} Iev)))
...   | evL  ¬cs _      = ⊥-elim (¬cs mem)
...   | evR  ¬cs _      = ⊥-elim (¬cs mem)
...   | evBoth ¬cs _ _  = ⊥-elim (¬cs mem)
sim-Tx-τ {i} {t} {r} {d} step | hτH {B} {e} {a} _ mem parev refl | rcvack fz dr id
      with dr ≟ lo | id ≟ N2N_KeepAlive
...   | yes refl | yes refl
      with Par-ev-elim csSR' ⊤merge (decI i d) (decT t d ⦀ decR r d) parev
...
sim-Tx-τ {i} {t} {r} {d} step | hτH {B} {e} {a} _ mem parev refl | rcvack fz dr id | yes refl | yes refl
      | evL  ¬cs _   = ⊥-elim (¬cs mem)
sim-Tx-τ {i} {t} {r} {d} step | hτH {B} {e} {a} _ mem parev refl | rcvack fz dr id | yes refl | yes refl
      | evR  ¬cs _   = ⊥-elim (¬cs mem)
sim-Tx-τ {i} {t} {r} {d} step | hτH {B} {e} {a} _ mem parev refl | rcvack fz dr id | yes refl | yes refl
      | evBoth ¬cs _ _ = ⊥-elim (¬cs mem)
sim-Tx-τ {i} {t} {r} {d} step | hτH {B} {e} {a} _ mem parev refl | rcvack fz dr id | no ¬dr | _
      with Par-ev-elim csSR' ⊤merge (decI i d) (decT t d ⦀ decR r d) parev
...   | evSync _ Iev _  = ⊥-elim (¬dr (proj₁ (decI-rcvack-pins {i} Iev)))
...   | evL  ¬cs _      = ⊥-elim (¬cs mem)
...   | evR  ¬cs _      = ⊥-elim (¬cs mem)
...   | evBoth ¬cs _ _  = ⊥-elim (¬cs mem)
sim-Tx-τ {i} {t} {r} {d} step | hτH {B} {e} {a} _ mem parev refl | rcvack fz dr id | yes refl | no ¬id
      with Par-ev-elim csSR' ⊤merge (decI i d) (decT t d ⦀ decR r d) parev
...   | evSync _ Iev _  = ⊥-elim (¬id (proj₂ (decI-rcvack-pins {i} Iev)))
...   | evL  ¬cs _      = ⊥-elim (¬cs mem)
...   | evR  ¬cs _      = ⊥-elim (¬cs mem)
...   | evBoth ¬cs _ _  = ⊥-elim (¬cs mem)
sim-Tx-τ {i} {t} {r} step | hτH {B} {e} {a} _ mem parev refl | input l dr id  = ⊥-elim mem
sim-Tx-τ {i} {t} {r} step | hτH {B} {e} {a} _ mem parev refl | output l dr id = ⊥-elim mem
sim-Tx-τ {i} {t} {r} step | hτH {B} {e} {a} _ mem parev refl | rcvmsg l dr id = ⊥-elim mem
sim-Tx-τ {i} {t} {r} step | hτH {B} {e} {a} _ mem parev refl | tx l dr id     = ⊥-elim mem
sim-Tx-τ {i} {t} {r} step | hτH {B} {e} {a} _ mem parev refl | sndack l dr id = ⊥-elim mem
sim-Tx-τ {i} {t} {r} step | hτH {B} {e} {a} _ mem parev refl | ack l dr id    = ⊥-elim mem
...
decI-input-class : ∀ {i d a W} →
  decI i d ─[ ev (evN (input fz lo N2N_KeepAlive) a) ]─► W → (i ≡ I0) × (W ≡ decI I1 a)
...
decI-no-tx : ∀ {i d a W dr id} →
  decI i d ─[ ev (evN (tx fz dr id) a) ]─► W → ⊥
...
decI-no-ack : ∀ {i d a W dr id} →
  decI i d ─[ ev (evN (ack fz dr id) a) ]─► W → ⊥
...
decI-no-output : ∀ {i d a W dr id} →
  decI i d ─[ ev (evN (output′ fz dr id) a) ]─► W → ⊥
...
decI-no-rcvmsg : ∀ {i d a W dr id} →
  decI i d ─[ ev (evN (rcvmsg fz dr id) a) ]─► W → ⊥
...
decI-no-sndack : ∀ {i d a W dr id} →
  decI i d ─[ ev (evN (sndack fz dr id) a) ]─► W → ⊥
...
decT-tx-class : ∀ {t d a W} →
  decT t d ─[ ev (evN (tx fz lo N2N_KeepAlive) a) ]─► W → (t ≡ T1) × (a ≡ d) × (W ≡ decT Tg d)
...
decR-ack-class : ∀ {r d a W} →
  decR r d ─[ ev (evN (ack fz lo N2N_KeepAlive) a) ]─► W → (r ≡ R0) × (W ≡ decR R1 d)
...
TR-tx-class : ∀ {t r d a W} →
  (decT t d ⦀ decR r d) ─[ ev (evN (tx fz lo N2N_KeepAlive) a) ]─► W →
...
TR-ack-class : ∀ {t r d a W} →
  (decT t d ⦀ decR r d) ─[ ev (evN (ack fz lo N2N_KeepAlive) a) ]─► W →
...
TR-no-input : ∀ {t r d a W dr id} →
  (decT t d ⦀ decR r d) ─[ ev (evN (input fz dr id) a) ]─► W → ⊥
...
TR-no-output : ∀ {t r d a W dr id} →
  (decT t d ⦀ decR r d) ─[ ev (evN (output′ fz dr id) a) ]─► W → ⊥
...
TR-no-rcvmsg : ∀ {t r d a W dr id} →
  (decT t d ⦀ decR r d) ─[ ev (evN (rcvmsg fz dr id) a) ]─► W → ⊥
...
TR-no-sndack : ∀ {t r d a W dr id} →
  (decT t d ⦀ decR r d) ─[ ev (evN (sndack fz dr id) a) ]─► W → ⊥
...
-- input pin (menu offer at I0): explicit (dir,id) enumeration.
decI-input-pins : ∀ {i d a W dr id} →
  decI i d ─[ ev (evN (input fz dr id) a) ]─► W → (dr ≡ lo) × (id ≡ N2N_KeepAlive)
decI-input-pins {I0} {dr = lo} {id = N2N_KeepAlive}    _ = refl , refl
decI-input-pins {I0} {dr = lo} {id = N2N_ChainSync}    (sVis refl ())
decI-input-pins {I0} {dr = lo} {id = N2N_BlockFetch}   (sVis refl ())
decI-input-pins {I0} {dr = lo} {id = N2N_TxSubmission} (sVis refl ())
decI-input-pins {I0} {dr = lo} {id = N2N_LeiosNotify}  (sVis refl ())
decI-input-pins {I0} {dr = lo} {id = N2N_LeiosFetch}   (sVis refl ())
decI-input-pins {I0} {dr = hi} {id}                    (sVis refl ())
decI-input-pins {I1} (sVis refl ())
decI-input-pins {I2} {d = d} step rewrite ≟-diag d with step
... | sVis refl h = nothing-absurd h
decI-input-pins {Ig} {d} step = ⊥-elim (decI-Ig-noev {d} step)

-- tx pin (Op.Output at T1): via Net-≟ (payload-agnostic on dir/id).
decT-tx-pins : ∀ {t d a W dr id} →
  decT t d ─[ ev (evN (tx fz dr id) a) ]─► W → (dr ≡ lo) × (id ≡ N2N_KeepAlive)
decT-tx-pins {T0} (sVis refl ())
decT-tx-pins {T1} {d} {a} {W} {dr} {id} (sVis refl br)
  with Net-≟ {Data} (Data , tx fz lo N2N_KeepAlive) (Data , tx fz dr id) | br
... | yes refl | _  = refl , refl
... | no  _    | ()
decT-tx-pins {Tg} {d} step = ⊥-elim (decT-Tg-noev {d} step)

TR-tx-pins : ∀ {t r d a W dr id} →
  (decT t d ⦀ decR r d) ─[ ev (evN (tx fz dr id) a) ]─► W → (dr ≡ lo) × (id ≡ N2N_KeepAlive)
TR-tx-pins {t} {r} {d} step with Par-ev-elim ∅ES ⊤merge (decT t d) (decR r d) step
... | evSync mem _ _  = ⊥-elim mem
... | evL  _ Tev      = decT-tx-pins {t} Tev
... | evR  _ Rev      = ⊥-elim (decR-no-tx {r} {d} Rev)
... | evBoth _ Tev _  = decT-tx-pins {t} Tev

-- generalized ack classifier: RcvAck accepts ack at ANY (dir,id).
decR-ack-class-gen : ∀ {r d a W dr id} →
  decR r d ─[ ev (evN (ack fz dr id) a) ]─► W →
  (r ≡ R0) × (W ≡ succV RcvAck (⊤ , ack fz dr id) a)
decR-ack-class-gen {R0} (sVis refl refl) = refl , refl
decR-ack-class-gen {R1} (sVis refl ())
decR-ack-class-gen {Rg} {d} step = ⊥-elim (decR-Rg-noev {d} step)

TR-ack-class-gen : ∀ {t r d a W dr id} →
  (decT t d ⦀ decR r d) ─[ ev (evN (ack fz dr id) a) ]─► W →
  (r ≡ R0) × (W ≡ (decT t d ⦀ succV RcvAck (⊤ , ack fz dr id) a))
TR-ack-class-gen {t} {r} {d} step with Par-ev-elim ∅ES ⊤merge (decT t d) (decR r d) step
... | evSync mem _ _  = ⊥-elim mem
... | evL  _ Tev      = ⊥-elim (decT-no-ack {t} {d} Tev)
... | evR  _ Rev      = proj₁ cl , cong (λ z → decT t d ⦀ z) (proj₂ cl)
  where cl = decR-ack-class-gen {r} {d} Rev
... | evBoth _ Tev _  = ⊥-elim (decT-no-ack {t} {d} Tev)
...
sim-Tx-ev : ∀ {i t r d B} {e : Net Data B} {a} {W} →
  ...
  ⊎ ((r ≡ R0) × Σ[ dr ∈ Dir ] Σ[ id ∈ IDs ]
        (evl (evLabel B e a) ≡ ackLbl-at dr id)
      × (W ≡ ((decI i d) ∥⇘ csSR' ⇙ (decT t d ⦀ succV RcvAck (⊤ , ack fz dr id) tt)) ∖ csSR'))
sim-Tx-ev {i} {t} {r} {d} step
  with Hide-ev-elim csSR' ((decI i d) ∥⇘ csSR' ⇙ (decT t d ⦀ decR r d)) step
... | heV {B} {e} {a} _ ¬cs parev with e
... | input fz dr id with dr ≟ lo | id ≟ N2N_KeepAlive
...   | yes refl | yes refl
      with Par-ev-elim csSR' ⊤merge (decI i d) (decT t d ⦀ decR r d) parev
...     | evSync mem _ _   = ⊥-elim mem
...
sim-Tx-ev {i} {t} {r} {d} step | heV {B} {e} {a} _ ¬cs parev | input fz dr id | yes refl | yes refl
      | evR  _ TRev      = ⊥-elim (TR-no-input {t} {r} TRev)
sim-Tx-ev {i} {t} {r} {d} step | heV {B} {e} {a} _ ¬cs parev | input fz dr id | yes refl | yes refl
      | evBoth _ _ TRev  = ⊥-elim (TR-no-input {t} {r} TRev)
sim-Tx-ev {i} {t} {r} {d} step | heV {B} {e} {a} _ ¬cs parev | input fz dr id | no ¬dr | _
      with Par-ev-elim csSR' ⊤merge (decI i d) (decT t d ⦀ decR r d) parev
...   | evSync mem _ _   = ⊥-elim mem
...   | evL  _ Iev       = ⊥-elim (¬dr (proj₁ (decI-input-pins {i} Iev)))
...   | evR  _ TRev      = ⊥-elim (TR-no-input {t} {r} TRev)
...   | evBoth _ _ TRev  = ⊥-elim (TR-no-input {t} {r} TRev)
sim-Tx-ev {i} {t} {r} {d} step | heV {B} {e} {a} _ ¬cs parev | input fz dr id | yes refl | no ¬id
      with Par-ev-elim csSR' ⊤merge (decI i d) (decT t d ⦀ decR r d) parev
...   | evSync mem _ _   = ⊥-elim mem
...   | evL  _ Iev       = ⊥-elim (¬id (proj₂ (decI-input-pins {i} Iev)))
...   | evR  _ TRev      = ⊥-elim (TR-no-input {t} {r} TRev)
...   | evBoth _ _ TRev  = ⊥-elim (TR-no-input {t} {r} TRev)
sim-Tx-ev {i} {t} {r} {d} step | heV {B} {e} {a} _ ¬cs parev | tx fz dr id
      with dr ≟ lo | id ≟ N2N_KeepAlive
...   | yes refl | yes refl
      with Par-ev-elim csSR' ⊤merge (decI i d) (decT t d ⦀ decR r d) parev
...     | evSync mem _ _   = ⊥-elim mem
...
...     | evR  _ TRev      = inj₂ (inj₁ (proj₁ cl ,
            cong (λ z → evl (evLabel Data (tx fz lo N2N_KeepAlive) z)) (proj₁ (proj₂ cl)) ,
            cong (λ z → (((decI i d) ∥⇘ csSR' ⇙ z) ∖ csSR')) (proj₂ (proj₂ cl))))
  where cl = TR-tx-class {t} {r} {d} TRev
sim-Tx-ev {i} {t} {r} {d} step | heV {B} {e} {a} _ ¬cs parev | tx fz dr id | yes refl | yes refl
      | evBoth _ Iev _   = ⊥-elim (decI-no-tx {i} Iev)
sim-Tx-ev {i} {t} {r} {d} step | heV {B} {e} {a} _ ¬cs parev | tx fz dr id | no ¬dr | _
      with Par-ev-elim csSR' ⊤merge (decI i d) (decT t d ⦀ decR r d) parev
...   | evSync mem _ _   = ⊥-elim mem
...   | evL  _ Iev       = ⊥-elim (decI-no-tx {i} Iev)
...   | evR  _ TRev      = ⊥-elim (¬dr (proj₁ (TR-tx-pins {t} {r} {d} TRev)))
...   | evBoth _ Iev _   = ⊥-elim (decI-no-tx {i} Iev)
sim-Tx-ev {i} {t} {r} {d} step | heV {B} {e} {a} _ ¬cs parev | tx fz dr id | yes refl | no ¬id
      with Par-ev-elim csSR' ⊤merge (decI i d) (decT t d ⦀ decR r d) parev
...   | evSync mem _ _   = ⊥-elim mem
...   | evL  _ Iev       = ⊥-elim (decI-no-tx {i} Iev)
...   | evR  _ TRev      = ⊥-elim (¬id (proj₂ (TR-tx-pins {t} {r} {d} TRev)))
...   | evBoth _ Iev _   = ⊥-elim (decI-no-tx {i} Iev)
sim-Tx-ev {i} {t} {r} {d} step | heV {B} {e} {a} _ ¬cs parev | ack fz dr id
      with Par-ev-elim csSR' ⊤merge (decI i d) (decT t d ⦀ decR r d) parev
...   | evSync mem _ _   = ⊥-elim mem
...   | evL  _ Iev       = ⊥-elim (decI-no-ack {i} Iev)
...   | evR  _ TRev      = inj₂ (inj₂ (proj₁ cl , dr , id , refl ,
            cong (λ z → (((decI i d) ∥⇘ csSR' ⇙ z) ∖ csSR')) (proj₂ cl)))
  where cl = TR-ack-class-gen {t} {r} {d} TRev
...   | evBoth _ Iev _   = ⊥-elim (decI-no-ack {i} Iev)
sim-Tx-ev {i} {t} {r} step | heV {B} {e} {a} _ ¬cs parev | sndmsg l dr id = ⊥-elim (¬cs Poly.tt)
sim-Tx-ev {i} {t} {r} step | heV {B} {e} {a} _ ¬cs parev | rcvack l dr id = ⊥-elim (¬cs Poly.tt)
sim-Tx-ev {i} {t} {r} {d} step | heV {B} {e} {a} _ ¬cs parev | output fz dr id
      with Par-ev-elim csSR' ⊤merge (decI i d) (decT t d ⦀ decR r d) parev
...   | evSync mem _ _   = ⊥-elim mem
...   | evL  _ Iev       = ⊥-elim (decI-no-output {i} Iev)
...   | evR  _ TRev      = ⊥-elim (TR-no-output {t} {r} TRev)
...   | evBoth _ Iev _   = ⊥-elim (decI-no-output {i} Iev)
sim-Tx-ev {i} {t} {r} {d} step | heV {B} {e} {a} _ ¬cs parev | rcvmsg fz dr id
      with Par-ev-elim csSR' ⊤merge (decI i d) (decT t d ⦀ decR r d) parev
...   | evSync mem _ _   = ⊥-elim mem
...   | evL  _ Iev       = ⊥-elim (decI-no-rcvmsg {i} Iev)
...   | evR  _ TRev      = ⊥-elim (TR-no-rcvmsg {t} {r} TRev)
...   | evBoth _ Iev _   = ⊥-elim (decI-no-rcvmsg {i} Iev)
sim-Tx-ev {i} {t} {r} {d} step | heV {B} {e} {a} _ ¬cs parev | sndack fz dr id
      with Par-ev-elim csSR' ⊤merge (decI i d) (decT t d ⦀ decR r d) parev
...   | evSync mem _ _   = ⊥-elim mem
...
decO-rcvmsg-class : ∀ {o d a W} →
  decO o d ─[ ev (evN (rcvmsg fz lo N2N_KeepAlive) a) ]─► W → (o ≡ O0) × (W ≡ decO O1 a)
...
decO-sndack-class : ∀ {o d a W} →
  decO o d ─[ ev (evN (sndack fz lo N2N_KeepAlive) a) ]─► W → (o ≡ O2) × (W ≡ decO Og d)
...
decC-rcvmsg-class : ∀ {c d a W} →
  decC c d ─[ ev (evN (rcvmsg fz lo N2N_KeepAlive) a) ]─► W →
...
decC-no-sndack : ∀ {c d a W dr id} →
  decC c d ─[ ev (evN (sndack fz dr id) a) ]─► W → ⊥
...
decS-sndack-class : ∀ {s d a W} →
  decS s d ─[ ev (evN (sndack fz lo N2N_KeepAlive) a) ]─► W → (s ≡ Sa0) × (W ≡ decS Sa1 d)
...
decS-no-rcvmsg : ∀ {s d a W dr id} →
  decS s d ─[ ev (evN (rcvmsg fz dr id) a) ]─► W → ⊥
...
RS-rcvmsg-class : ∀ {c s d a W} →
  (decC c d ⦀ decS s d) ─[ ev (evN (rcvmsg fz lo N2N_KeepAlive) a) ]─► W →
...
RS-sndack-class : ∀ {c s d a W} →
  (decC c d ⦀ decS s d) ─[ ev (evN (sndack fz lo N2N_KeepAlive) a) ]─► W →
...
-- Rx-side (dir,id) pins for the csRS sync channels.
decO-rcvmsg-pins : ∀ {o d a W dr id} →
  decO o d ─[ ev (evN (rcvmsg fz dr id) a) ]─► W → (dr ≡ lo) × (id ≡ N2N_KeepAlive)
decO-rcvmsg-pins {O0} {dr = lo} {id = N2N_KeepAlive}    _ = refl , refl
decO-rcvmsg-pins {O0} {dr = lo} {id = N2N_ChainSync}    (sVis refl ())
decO-rcvmsg-pins {O0} {dr = lo} {id = N2N_BlockFetch}   (sVis refl ())
decO-rcvmsg-pins {O0} {dr = lo} {id = N2N_TxSubmission} (sVis refl ())
decO-rcvmsg-pins {O0} {dr = lo} {id = N2N_LeiosNotify}  (sVis refl ())
decO-rcvmsg-pins {O0} {dr = lo} {id = N2N_LeiosFetch}   (sVis refl ())
decO-rcvmsg-pins {O0} {dr = hi} {id}                    (sVis refl ())
decO-rcvmsg-pins {O1} (sVis refl ())
decO-rcvmsg-pins {O2} {d = d} step rewrite ≟-diag d with step
... | sVis refl h = nothing-absurd h
decO-rcvmsg-pins {Og} {d} step = ⊥-elim (decO-Og-noev {d} step)

decO-sndack-pins : ∀ {o d a W dr id} →
  decO o d ─[ ev (evN (sndack fz dr id) a) ]─► W → (dr ≡ lo) × (id ≡ N2N_KeepAlive)
decO-sndack-pins {O0} (sVis refl ())
decO-sndack-pins {O1} (sVis refl ())
decO-sndack-pins {O2} {d = d} {dr = dr} {id = id} step rewrite ≟-diag d with step
... | sVis refl br
      with Net-≟ {Data} (⊤ , sndack fz lo N2N_KeepAlive) (⊤ , sndack fz dr id) | br
...   | yes refl | _  = refl , refl
...   | no  _    | ()
decO-sndack-pins {Og} {d} step = ⊥-elim (decO-Og-noev {d} step)
...
sim-Rx-τ {o} {c} {s} {d} step
  | hτH {B} {e} {a} _ mem parev refl with e
... | rcvmsg fz dr id with dr ≟ lo | id ≟ N2N_KeepAlive
...   | yes refl | yes refl
...
sim-Rx-τ {o} {c} {s} {d} step | hτH {B} {e} {a} _ mem parev refl | rcvmsg fz dr id | yes refl | yes refl
      | evL  ¬cs _   = ⊥-elim (¬cs mem)
sim-Rx-τ {o} {c} {s} {d} step | hτH {B} {e} {a} _ mem parev refl | rcvmsg fz dr id | yes refl | yes refl
      | evR  ¬cs _   = ⊥-elim (¬cs mem)
sim-Rx-τ {o} {c} {s} {d} step | hτH {B} {e} {a} _ mem parev refl | rcvmsg fz dr id | yes refl | yes refl
      | evBoth ¬cs _ _ = ⊥-elim (¬cs mem)
sim-Rx-τ {o} {c} {s} {d} step | hτH {B} {e} {a} _ mem parev refl | rcvmsg fz dr id | no ¬dr | _
      with Par-ev-elim csRS' ⊤merge (decO o d) (decC c d ⦀ decS s d) parev
...   | evSync _ Oev _  = ⊥-elim (¬dr (proj₁ (decO-rcvmsg-pins {o} Oev)))
...   | evL  ¬cs _      = ⊥-elim (¬cs mem)
...   | evR  ¬cs _      = ⊥-elim (¬cs mem)
...   | evBoth ¬cs _ _  = ⊥-elim (¬cs mem)
sim-Rx-τ {o} {c} {s} {d} step | hτH {B} {e} {a} _ mem parev refl | rcvmsg fz dr id | yes refl | no ¬id
      with Par-ev-elim csRS' ⊤merge (decO o d) (decC c d ⦀ decS s d) parev
...   | evSync _ Oev _  = ⊥-elim (¬id (proj₂ (decO-rcvmsg-pins {o} Oev)))
...   | evL  ¬cs _      = ⊥-elim (¬cs mem)
...   | evR  ¬cs _      = ⊥-elim (¬cs mem)
...   | evBoth ¬cs _ _  = ⊥-elim (¬cs mem)
sim-Rx-τ {o} {c} {s} {d} step | hτH {B} {e} {a} _ mem parev refl | sndack fz dr id
      with dr ≟ lo | id ≟ N2N_KeepAlive
...   | yes refl | yes refl
      with Par-ev-elim csRS' ⊤merge (decO o d) (decC c d ⦀ decS s d) parev
...
sim-Rx-τ {o} {c} {s} {d} step | hτH {B} {e} {a} _ mem parev refl | sndack fz dr id | yes refl | yes refl
      | evL  ¬cs _   = ⊥-elim (¬cs mem)
sim-Rx-τ {o} {c} {s} {d} step | hτH {B} {e} {a} _ mem parev refl | sndack fz dr id | yes refl | yes refl
      | evR  ¬cs _   = ⊥-elim (¬cs mem)
sim-Rx-τ {o} {c} {s} {d} step | hτH {B} {e} {a} _ mem parev refl | sndack fz dr id | yes refl | yes refl
      | evBoth ¬cs _ _ = ⊥-elim (¬cs mem)
sim-Rx-τ {o} {c} {s} {d} step | hτH {B} {e} {a} _ mem parev refl | sndack fz dr id | no ¬dr | _
      with Par-ev-elim csRS' ⊤merge (decO o d) (decC c d ⦀ decS s d) parev
...   | evSync _ Oev _  = ⊥-elim (¬dr (proj₁ (decO-sndack-pins {o} Oev)))
...   | evL  ¬cs _      = ⊥-elim (¬cs mem)
...   | evR  ¬cs _      = ⊥-elim (¬cs mem)
...   | evBoth ¬cs _ _  = ⊥-elim (¬cs mem)
sim-Rx-τ {o} {c} {s} {d} step | hτH {B} {e} {a} _ mem parev refl | sndack fz dr id | yes refl | no ¬id
      with Par-ev-elim csRS' ⊤merge (decO o d) (decC c d ⦀ decS s d) parev
...   | evSync _ Oev _  = ⊥-elim (¬id (proj₂ (decO-sndack-pins {o} Oev)))
...   | evL  ¬cs _      = ⊥-elim (¬cs mem)
...   | evR  ¬cs _      = ⊥-elim (¬cs mem)
...   | evBoth ¬cs _ _  = ⊥-elim (¬cs mem)
sim-Rx-τ {o} {c} {s} step | hτH {B} {e} {a} _ mem parev refl | input l dr id  = ⊥-elim mem
sim-Rx-τ {o} {c} {s} step | hτH {B} {e} {a} _ mem parev refl | output l dr id = ⊥-elim mem
sim-Rx-τ {o} {c} {s} step | hτH {B} {e} {a} _ mem parev refl | tx l dr id     = ⊥-elim mem
sim-Rx-τ {o} {c} {s} step | hτH {B} {e} {a} _ mem parev refl | sndmsg l dr id = ⊥-elim mem
sim-Rx-τ {o} {c} {s} step | hτH {B} {e} {a} _ mem parev refl | rcvack l dr id = ⊥-elim mem
sim-Rx-τ {o} {c} {s} step | hτH {B} {e} {a} _ mem parev refl | ack l dr id    = ⊥-elim mem
...
decO-output-class : ∀ {o d a W} →
  decO o d ─[ ev (evN (output′ fz lo N2N_KeepAlive) a) ]─► W → (o ≡ O1) × (a ≡ d) × (W ≡ decO O2 d)
...
decO-no-tx : ∀ {o d a W dr id} →
  decO o d ─[ ev (evN (tx fz dr id) a) ]─► W → ⊥
...
decO-no-ack : ∀ {o d a W dr id} →
  decO o d ─[ ev (evN (ack fz dr id) a) ]─► W → ⊥
...
decO-no-input : ∀ {o d a W dr id} →
  decO o d ─[ ev (evN (input fz dr id) a) ]─► W → ⊥
...
decO-no-sndmsg : ∀ {o d a W dr id} →
  decO o d ─[ ev (evN (sndmsg fz dr id) a) ]─► W → ⊥
...
decO-no-rcvack : ∀ {o d a W dr id} →
  decO o d ─[ ev (evN (rcvack fz dr id) a) ]─► W → ⊥
...
decC-tx-class : ∀ {c d a W} →
  decC c d ─[ ev (evN (tx fz lo N2N_KeepAlive) a) ]─► W → (c ≡ Rc0) × (W ≡ decC Rc1 a)
...
decS-ack-class : ∀ {s d a W} →
  decS s d ─[ ev (evN (ack fz lo N2N_KeepAlive) a) ]─► W → (s ≡ Sa1) × (W ≡ decS Sag d)
...
RS-tx-class : ∀ {c s d a W} →
  (decC c d ⦀ decS s d) ─[ ev (evN (tx fz lo N2N_KeepAlive) a) ]─► W →
...
RS-ack-class : ∀ {c s d a W} →
  (decC c d ⦀ decS s d) ─[ ev (evN (ack fz lo N2N_KeepAlive) a) ]─► W →
...
RS-no-output : ∀ {c s d a W dr id} →
  (decC c d ⦀ decS s d) ─[ ev (evN (output′ fz dr id) a) ]─► W → ⊥
...
RS-no-input : ∀ {c s d a W dr id} →
  (decC c d ⦀ decS s d) ─[ ev (evN (input fz dr id) a) ]─► W → ⊥
...
RS-no-sndmsg : ∀ {c s d a W dr id} →
  (decC c d ⦀ decS s d) ─[ ev (evN (sndmsg fz dr id) a) ]─► W → ⊥
...
RS-no-rcvack : ∀ {c s d a W dr id} →
  (decC c d ⦀ decS s d) ─[ ev (evN (rcvack fz dr id) a) ]─► W → ⊥
...
-- output pin (Op.Output at O1): via Net-≟.
decO-output-pins : ∀ {o d a W dr id} →
  decO o d ─[ ev (evN (output′ fz dr id) a) ]─► W → (dr ≡ lo) × (id ≡ N2N_KeepAlive)
decO-output-pins {O0} (sVis refl ())
decO-output-pins {O1} {d} {a} {W} {dr} {id} (sVis refl br)
  with Net-≟ {Data} (Data , output′ fz lo N2N_KeepAlive) (Data , output′ fz dr id) | br
... | yes refl | _  = refl , refl
... | no  _    | ()
decO-output-pins {O2} {d = d} step rewrite ≟-diag d with step
... | sVis refl h = nothing-absurd h
decO-output-pins {Og} {d} step = ⊥-elim (decO-Og-noev {d} step)

-- ack pin (Prefix emit at Sa1): via Net-≟.
decS-ack-pins : ∀ {s d a W dr id} →
  decS s d ─[ ev (evN (ack fz dr id) a) ]─► W → (dr ≡ lo) × (id ≡ N2N_KeepAlive)
decS-ack-pins {Sa0} (sVis refl ())
decS-ack-pins {Sa1} {d} {a} {W} {dr} {id} (sVis refl br)
  with Net-≟ {Data} (⊤ , ack fz lo N2N_KeepAlive) (⊤ , ack fz dr id) | br
... | yes refl | _  = refl , refl
... | no  _    | ()
decS-ack-pins {Sag} {d} step = ⊥-elim (decS-Sag-noev {d} step)

RS-ack-pins : ∀ {c s d a W dr id} →
  (decC c d ⦀ decS s d) ─[ ev (evN (ack fz dr id) a) ]─► W → (dr ≡ lo) × (id ≡ N2N_KeepAlive)
RS-ack-pins {c} {s} {d} step with Par-ev-elim ∅ES ⊤merge (decC c d) (decS s d) step
... | evSync mem _ _  = ⊥-elim mem
... | evL  _ Cev      = ⊥-elim (decC-no-ack {c} {d} Cev)
... | evR  _ Sev      = decS-ack-pins {s} {d} Sev
... | evBoth _ Cev _  = ⊥-elim (decC-no-ack {c} {d} Cev)

-- generalized tx classifier: Receiver accepts tx at ANY (dir,id), fresh payload.
decC-tx-class-gen : ∀ {c d a W dr id} →
  decC c d ─[ ev (evN (tx fz dr id) a) ]─► W →
  (c ≡ Rc0) × (W ≡ succV Receiver (Data , tx fz dr id) a)
decC-tx-class-gen {Rc0} (sVis refl refl) = refl , refl
decC-tx-class-gen {Rc1} (sVis refl ())
decC-tx-class-gen {Rcg} {d} step = ⊥-elim (decC-Rcg-noev {d} step)

RS-tx-class-gen : ∀ {c s d a W dr id} →
  (decC c d ⦀ decS s d) ─[ ev (evN (tx fz dr id) a) ]─► W →
  (c ≡ Rc0) × (W ≡ (succV Receiver (Data , tx fz dr id) a ⦀ decS s d))
RS-tx-class-gen {c} {s} {d} step with Par-ev-elim ∅ES ⊤merge (decC c d) (decS s d) step
... | evSync mem _ _   = ⊥-elim mem
... | evL  _ Cev       = proj₁ cl , cong (λ z → z ⦀ decS s d) (proj₂ cl)
  where cl = decC-tx-class-gen {c} {d} Cev
... | evR  _ Sev       = ⊥-elim (decS-no-tx {s} {d} Sev)
... | evBoth _ _ Sev   = ⊥-elim (decS-no-tx {s} {d} Sev)
...
sim-Rx-ev : ∀ {o c s d B} {e : Net Data B} {a} {W} →
  ...
  ⊎ (Σ[ a′ ∈ Data ] Σ[ dr ∈ Dir ] Σ[ id ∈ IDs ]
        ((c ≡ Rc0) × (evl (evLabel B e a) ≡ txLbl-at dr id a′)
          × (W ≡ ((decO o d) ∥⇘ csRS' ⇙ (succV Receiver (Data , tx fz dr id) a′ ⦀ decS s d)) ∖ csRS')))
...
... | heV {B} {e} {a} _ ¬cs parev with e
... | output fz dr id with dr ≟ lo | id ≟ N2N_KeepAlive
...   | yes refl | yes refl
      with Par-ev-elim csRS' ⊤merge (decO o d) (decC c d ⦀ decS s d) parev
...     | evSync mem _ _   = ⊥-elim mem
...     | evL  _ Oev       = inj₁ (proj₁ cl ,
            cong (λ z → evl (evLabel Data (output′ fz lo N2N_KeepAlive) z)) (proj₁ (proj₂ cl)) ,
            cong (λ z → ((z ∥⇘ csRS' ⇙ (decC c d ⦀ decS s d)) ∖ csRS')) (proj₂ (proj₂ cl)))
  where cl = decO-output-class {o} {d} Oev
sim-Rx-ev {o} {c} {s} {d} step | heV {B} {e} {a} _ ¬cs parev | output fz dr id | yes refl | yes refl
      | evR  _ RSev      = ⊥-elim (RS-no-output {c} {s} RSev)
sim-Rx-ev {o} {c} {s} {d} step | heV {B} {e} {a} _ ¬cs parev | output fz dr id | yes refl | yes refl
      | evBoth _ _ RSev  = ⊥-elim (RS-no-output {c} {s} RSev)
sim-Rx-ev {o} {c} {s} {d} step | heV {B} {e} {a} _ ¬cs parev | output fz dr id | no ¬dr | _
      with Par-ev-elim csRS' ⊤merge (decO o d) (decC c d ⦀ decS s d) parev
...   | evSync mem _ _   = ⊥-elim mem
...   | evL  _ Oev       = ⊥-elim (¬dr (proj₁ (decO-output-pins {o} Oev)))
...   | evR  _ RSev      = ⊥-elim (RS-no-output {c} {s} RSev)
...   | evBoth _ _ RSev  = ⊥-elim (RS-no-output {c} {s} RSev)
sim-Rx-ev {o} {c} {s} {d} step | heV {B} {e} {a} _ ¬cs parev | output fz dr id | yes refl | no ¬id
      with Par-ev-elim csRS' ⊤merge (decO o d) (decC c d ⦀ decS s d) parev
...   | evSync mem _ _   = ⊥-elim mem
...   | evL  _ Oev       = ⊥-elim (¬id (proj₂ (decO-output-pins {o} Oev)))
...   | evR  _ RSev      = ⊥-elim (RS-no-output {c} {s} RSev)
...   | evBoth _ _ RSev  = ⊥-elim (RS-no-output {c} {s} RSev)
sim-Rx-ev {o} {c} {s} {d} step | heV {B} {e} {a} _ ¬cs parev | tx fz dr id
      with Par-ev-elim csRS' ⊤merge (decO o d) (decC c d ⦀ decS s d) parev
...   | evSync mem _ _   = ⊥-elim mem
...   | evL  _ Oev       = ⊥-elim (decO-no-tx {o} {d} Oev)
...   | evR  _ RSev      = inj₂ (inj₁ (a , dr , id , proj₁ cl , refl ,
            cong (λ z → (((decO o d) ∥⇘ csRS' ⇙ z) ∖ csRS')) (proj₂ cl)))
  where cl = RS-tx-class-gen {c} {s} {d} RSev
...   | evBoth _ Oev _   = ⊥-elim (decO-no-tx {o} {d} Oev)
sim-Rx-ev {o} {c} {s} {d} step | heV {B} {e} {a} _ ¬cs parev | ack fz dr id
      with dr ≟ lo | id ≟ N2N_KeepAlive
...   | yes refl | yes refl
      with Par-ev-elim csRS' ⊤merge (decO o d) (decC c d ⦀ decS s d) parev
...     | evSync mem _ _   = ⊥-elim mem
...
sim-Rx-ev {o} {c} {s} {d} step | heV {B} {e} {a} _ ¬cs parev | ack fz dr id | yes refl | yes refl
      | evBoth _ Oev _   = ⊥-elim (decO-no-ack {o} {d} Oev)
sim-Rx-ev {o} {c} {s} {d} step | heV {B} {e} {a} _ ¬cs parev | ack fz dr id | no ¬dr | _
      with Par-ev-elim csRS' ⊤merge (decO o d) (decC c d ⦀ decS s d) parev
...   | evSync mem _ _   = ⊥-elim mem
...   | evL  _ Oev       = ⊥-elim (decO-no-ack {o} {d} Oev)
...   | evR  _ RSev      = ⊥-elim (¬dr (proj₁ (RS-ack-pins {c} {s} {d} RSev)))
...   | evBoth _ Oev _   = ⊥-elim (decO-no-ack {o} {d} Oev)
sim-Rx-ev {o} {c} {s} {d} step | heV {B} {e} {a} _ ¬cs parev | ack fz dr id | yes refl | no ¬id
      with Par-ev-elim csRS' ⊤merge (decO o d) (decC c d ⦀ decS s d) parev
...   | evSync mem _ _   = ⊥-elim mem
...   | evL  _ Oev       = ⊥-elim (decO-no-ack {o} {d} Oev)
...   | evR  _ RSev      = ⊥-elim (¬id (proj₂ (RS-ack-pins {c} {s} {d} RSev)))
...   | evBoth _ Oev _   = ⊥-elim (decO-no-ack {o} {d} Oev)
sim-Rx-ev {o} {c} {s} step | heV {B} {e} {a} _ ¬cs parev | rcvmsg l dr id = ⊥-elim (¬cs Poly.tt)
sim-Rx-ev {o} {c} {s} step | heV {B} {e} {a} _ ¬cs parev | sndack l dr id = ⊥-elim (¬cs Poly.tt)
sim-Rx-ev {o} {c} {s} {d} step | heV {B} {e} {a} _ ¬cs parev | input fz dr id
      with Par-ev-elim csRS' ⊤merge (decO o d) (decC c d ⦀ decS s d) parev
...   | evSync mem _ _   = ⊥-elim mem
...   | evL  _ Oev       = ⊥-elim (decO-no-input {o} {d} Oev)
...   | evR  _ RSev      = ⊥-elim (RS-no-input {c} {s} RSev)
...   | evBoth _ Oev _   = ⊥-elim (decO-no-input {o} {d} Oev)
sim-Rx-ev {o} {c} {s} {d} step | heV {B} {e} {a} _ ¬cs parev | sndmsg fz dr id
      with Par-ev-elim csRS' ⊤merge (decO o d) (decC c d ⦀ decS s d) parev
...   | evSync mem _ _   = ⊥-elim mem
...   | evL  _ Oev       = ⊥-elim (decO-no-sndmsg {o} {d} Oev)
...   | evR  _ RSev      = ⊥-elim (RS-no-sndmsg {c} {s} RSev)
...   | evBoth _ Oev _   = ⊥-elim (decO-no-sndmsg {o} {d} Oev)
sim-Rx-ev {o} {c} {s} {d} step | heV {B} {e} {a} _ ¬cs parev | rcvack fz dr id
      with Par-ev-elim csRS' ⊤merge (decO o d) (decC c d ⦀ decS s d) parev
...   | evSync mem _ _   = ⊥-elim mem
...   | evL  _ Oev       = ⊥-elim (decO-no-rcvack {o} {d} Oev)
...   | evR  _ RSev      = ⊥-elim (RS-no-rcvack {c} {s} RSev)
...   | evBoth _ Oev _   = ⊥-elim (decO-no-rcvack {o} {d} Oev)
...
-- Generalized (any dir,id) diseq/mem lemmas for the accept-any drainer disjuncts.
inputLbl≢txg : ∀ {a dr id a′} → inputLbl a ≡ txLbl-at dr id a′ → ⊥
inputLbl≢txg ()
outputLbl≢ackg : ∀ {a dr id} → outputLbl a ≡ ackLbl-at dr id → ⊥
outputLbl≢ackg ()
txg≢ackg : ∀ {dr id a′ dr₂ id₂} → txLbl-at dr id a′ ≡ ackLbl-at dr₂ id₂ → ⊥
txg≢ackg ()
txg→mem : ∀ {B} {e : Net Data B} {a} {dr id a′}
        → evl (evLabel B e a) ≡ txLbl-at dr id a′ → csTA' .mem (B , e) a
txg→mem refl = Poly.tt
ackg→mem : ∀ {B} {e : Net Data B} {a} {dr id}
         → evl (evLabel B e a) ≡ ackLbl-at dr id → csTA' .mem (B , e) a
...
-- Tx = ack (generalized): incompatible with Rx = output / tx.
sim-modA (mkCS i t r o c s) {d} (maE mem parev) | evSync _ Txev Rxev
  | inj₂ (inj₂ (refl , dr , id , Lack , _)) | inj₁ (_ , Lout , _) =
          ⊥-elim (outputLbl≢ackg (trans (sym Lout) Lack))
sim-modA (mkCS i t r o c s) {d} (maE mem parev) | evSync _ Txev Rxev
  | inj₂ (inj₂ (refl , dr , id , Lack , _)) | inj₂ (inj₁ (_ , _ , _ , _ , Ltx , _)) =
          ⊥-elim (txg≢ackg (trans (sym Ltx) Lack))
-- tx SYNC: Tx emits (pinned), Rx accepts at (dr,id,a′) ⇒ pin & build.
sim-modA (mkCS i t r o c s) {d} (maE mem parev) | evSync _ Txev Rxev
  | inj₂ (inj₁ (refl , Ltx , refl)) | inj₂ (inj₁ (a′ , dr , id , refl , Ltx′ , WeqRx))
      with trans (sym Ltx′) Ltx
... | refl = mkCS i Tg r o Rc1 s , NM.tx , d ,
      cong (Par⊤ csTA' (decTx i Tg r d)) WeqRx
-- ack SYNC: Rx emits (pinned), Tx accepts at (dr,id) ⇒ pin & build.
sim-modA (mkCS i t r o c s) {d} (maE mem parev) | evSync _ Txev Rxev
  | inj₂ (inj₂ (refl , dr , id , LackT , WeqT)) | inj₂ (inj₂ (refl , LackR , refl))
      with trans (sym LackT) LackR
... | refl = mkCS i t R1 o c Sag , NM.ack , d ,
      cong (λ z → Par⊤ csTA' z (decRx o c Sag d)) WeqT
...
...   | inj₂ (inj₁ (_ , _ , _ , _ , Ltx  , _)) = ⊥-elim (¬cs (txg→mem Ltx))
...
emit-I2-rcvack : ∀ {d} → decI I2 d ─[ ev (evN (rcvack fz lo N2N_KeepAlive) tt) ]─► decI Ig d
emit-I2-rcvack {d} = go d
  where
  go : ∀ d → decI I2 d ─[ ev (evN (rcvack fz lo N2N_KeepAlive) tt) ]─► decI Ig d
  go d rewrite ≟-diag d = sVis refl refl

emit-O2-sndack : ∀ {d} → decO O2 d ─[ ev (evN (sndack fz lo N2N_KeepAlive) tt) ]─► decO Og d
emit-O2-sndack {d} = go d
  where
  go : ∀ d → decO O2 d ─[ ev (evN (sndack fz lo N2N_KeepAlive) tt) ]─► decO Og d
  go d rewrite ≟-diag d = sVis refl refl
...
nR-sndmsg : ∀ r d → viewV (PTree.force (decR r d)) (Data , sndmsg fz lo N2N_KeepAlive) d ≡ nothing
nR-sndmsg R0 d = refl
nR-sndmsg R1 d = refl
nR-sndmsg Rg d = refl

nT-rcvack : ∀ t d → viewV (PTree.force (decT t d)) (⊤ , rcvack fz lo N2N_KeepAlive) tt ≡ nothing
nT-rcvack T0 d = refl
nT-rcvack T1 d = refl
nT-rcvack Tg d rewrite ≟-diag d = refl

nS-rcvmsg : ∀ s d → viewV (PTree.force (decS s d)) (Data , rcvmsg fz lo N2N_KeepAlive) d ≡ nothing
nS-rcvmsg Sa0 d = refl
nS-rcvmsg Sa1 d = refl
nS-rcvmsg Sag d = refl

nC-sndack : ∀ c d → viewV (PTree.force (decC c d)) (⊤ , sndack fz lo N2N_KeepAlive) tt ≡ nothing
nC-sndack Rc0 d = refl
nC-sndack Rc1 d = refl
nC-sndack Rcg d rewrite ≟-diag d = refl

-- single-leaf non-offers of tx / ack (for the top-sync solos).
nR-tx : ∀ r d → viewV (PTree.force (decR r d)) (Data , tx fz lo N2N_KeepAlive) d ≡ nothing
nR-tx R0 d = refl
nR-tx R1 d = refl
nR-tx Rg d = refl

nI-tx : ∀ i d → viewV (PTree.force (decI i d)) (Data , tx fz lo N2N_KeepAlive) d ≡ nothing
nI-tx I0 d = refl
nI-tx I1 d = refl
nI-tx I2 d rewrite ≟-diag d = refl
nI-tx Ig d rewrite ≟-diag d = refl

nS-tx : ∀ s d → viewV (PTree.force (decS s d)) (Data , tx fz lo N2N_KeepAlive) d ≡ nothing
nS-tx Sa0 d = refl
nS-tx Sa1 d = refl
nS-tx Sag d = refl

nO-tx : ∀ o d → viewV (PTree.force (decO o d)) (Data , tx fz lo N2N_KeepAlive) d ≡ nothing
nO-tx O0 d = refl
nO-tx O1 d = refl
nO-tx O2 d rewrite ≟-diag d = refl
nO-tx Og d rewrite ≟-diag d = refl

nT-ack : ∀ t d → viewV (PTree.force (decT t d)) (⊤ , ack fz lo N2N_KeepAlive) tt ≡ nothing
nT-ack T0 d = refl
nT-ack T1 d = refl
nT-ack Tg d rewrite ≟-diag d = refl

nI-ack : ∀ i d → viewV (PTree.force (decI i d)) (⊤ , ack fz lo N2N_KeepAlive) tt ≡ nothing
nI-ack I0 d = refl
nI-ack I1 d = refl
nI-ack I2 d rewrite ≟-diag d = refl
nI-ack Ig d rewrite ≟-diag d = refl

nC-ack : ∀ c d → viewV (PTree.force (decC c d)) (⊤ , ack fz lo N2N_KeepAlive) tt ≡ nothing
nC-ack Rc0 d = refl
nC-ack Rc1 d = refl
nC-ack Rcg d rewrite ≟-diag d = refl

nO-ack : ∀ o d → viewV (PTree.force (decO o d)) (⊤ , ack fz lo N2N_KeepAlive) tt ≡ nothing
nO-ack O0 d = refl
nO-ack O1 d = refl
...
nTR-input : ∀ t r d → viewV (PTree.force (decT t d ⦀ decR r d)) (Data , input fz lo N2N_KeepAlive) d ≡ nothing
nTR-input T0 R0 d = refl
nTR-input T0 R1 d = refl
nTR-input T0 Rg d = refl
nTR-input T1 R0 d = refl
nTR-input T1 R1 d = refl
nTR-input T1 Rg d = refl
nTR-input Tg R0 d rewrite ≟-diag d = refl
nTR-input Tg R1 d rewrite ≟-diag d = refl
nTR-input Tg Rg d rewrite ≟-diag d = refl

nCS-output : ∀ c s d → viewV (PTree.force (decC c d ⦀ decS s d)) (Data , output′ fz lo N2N_KeepAlive) d ≡ nothing
nCS-output Rc0 Sa0 d = refl
nCS-output Rc0 Sa1 d = refl
nCS-output Rc0 Sag d = refl
nCS-output Rc1 Sa0 d = refl
nCS-output Rc1 Sa1 d = refl
nCS-output Rc1 Sag d = refl
...
nRx-input : ∀ o c s d → viewV (PTree.force (decRx o c s d)) (Data , input fz lo N2N_KeepAlive) d ≡ nothing
nRx-input O0 Rc0 Sa0 d = refl
nRx-input O0 Rc0 Sa1 d = refl
nRx-input O0 Rc0 Sag d = refl
nRx-input O0 Rc1 Sa0 d = refl
nRx-input O0 Rc1 Sa1 d = refl
nRx-input O0 Rc1 Sag d = refl
...
nRx-input O1 Rc0 Sa0 d = refl
nRx-input O1 Rc0 Sa1 d = refl
nRx-input O1 Rc0 Sag d = refl
nRx-input O1 Rc1 Sa0 d = refl
nRx-input O1 Rc1 Sa1 d = refl
nRx-input O1 Rc1 Sag d = refl
...
nTx-output : ∀ i t r d → viewV (PTree.force (decTx i t r d)) (Data , output′ fz lo N2N_KeepAlive) d ≡ nothing
nTx-output I0 T0 R0 d = refl
nTx-output I0 T0 R1 d = refl
nTx-output I0 T0 Rg d = refl
nTx-output I0 T1 R0 d = refl
nTx-output I0 T1 R1 d = refl
nTx-output I0 T1 Rg d = refl
...
nTx-output I1 T0 R0 d = refl
nTx-output I1 T0 R1 d = refl
nTx-output I1 T0 Rg d = refl
nTx-output I1 T1 R0 d = refl
nTx-output I1 T1 R1 d = refl
nTx-output I1 T1 Rg d = refl
...
-- `Copy fz lo N2N_KeepAlive`.  Its lifecycle is three reachable states:
...
CopyLeaf-ev {e = input fz lo N2N_KeepAlive} {a = a} (sVis refl refl) = a , refl , refl
...
CopyLeaf-ev {e = output l dr id}               (sVis refl ())
CopyLeaf-ev {e = sndmsg l dr id}               (sVis refl ())
CopyLeaf-ev {e = rcvmsg l dr id}               (sVis refl ())
CopyLeaf-ev {e = tx     l dr id}               (sVis refl ())
CopyLeaf-ev {e = sndack l dr id}               (sVis refl ())
CopyLeaf-ev {e = rcvack l dr id}               (sVis refl ())
CopyLeaf-ev {e = ack    l dr id}               (sVis refl ())
...
... | _ , st2 , refl with CopyLeaf-ev st2
...
C1-evL {d} {e = output fz lo N2N_KeepAlive} {a} (sVis refl h) with a ≟ d
... | yes refl rewrite ≟-diag d = refl , sym (just-injective h)
... | no  _    = nothing-absurd h
C1-evL {e = output fz lo N2N_ChainSync}    (sVis refl ())
C1-evL {e = output fz lo N2N_BlockFetch}   (sVis refl ())
C1-evL {e = output fz lo N2N_TxSubmission} (sVis refl ())
C1-evL {e = output fz lo N2N_LeiosNotify}  (sVis refl ())
C1-evL {e = output fz lo N2N_LeiosFetch}   (sVis refl ())
C1-evL {e = output fz hi id} (sVis refl ())
C1-evL {e = input  l dr id} (sVis refl ())
C1-evL {e = sndmsg l dr id} (sVis refl ())
C1-evL {e = rcvmsg l dr id} (sVis refl ())
C1-evL {e = tx     l dr id} (sVis refl ())
C1-evL {e = sndack l dr id} (sVis refl ())
C1-evL {e = rcvack l dr id} (sVis refl ())
C1-evL {e = ack    l dr id} (sVis refl ())

...
nTR-input-q : ∀ t r dR a
            → viewV (PTree.force (decT t dR ⦀ decR r dR))
                    (Data , input fz lo N2N_KeepAlive) a ≡ nothing
nTR-input-q T0 R0 dR a = refl
nTR-input-q T0 R1 dR a = refl
nTR-input-q T0 Rg dR a = refl
nTR-input-q T1 R0 dR a = refl
nTR-input-q T1 R1 dR a = refl
nTR-input-q T1 Rg dR a = refl
...
nRx-input-q O0 Rc1 Sa0 dR a = refl
nRx-input-q O0 Rc1 Sa1 dR a = refl
nRx-input-q O0 Rc1 Sag dR a = refl
...
nRx-input-q O1 Rc0 Sa0 dR a = refl
nRx-input-q O1 Rc0 Sa1 dR a = refl
nRx-input-q O1 Rc0 Sag dR a = refl
nRx-input-q O1 Rc1 Sa0 dR a = refl
nRx-input-q O1 Rc1 Sa1 dR a = refl
nRx-input-q O1 Rc1 Sag dR a = refl
...
sim-modA-d (mkCS i t r o c s) {d} (maE mem parev) | evSync _ Txev Rxev

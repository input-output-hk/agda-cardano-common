...
module CSP.Examples.Cardano_network.FourNode.Liveness.LTL.Value.PipeTauMed (blkA : Block₃) where
...
open import CSP.Examples.Cardano_network.FourNode.Liveness.LTL.Value.PipeIoHandoff blkA

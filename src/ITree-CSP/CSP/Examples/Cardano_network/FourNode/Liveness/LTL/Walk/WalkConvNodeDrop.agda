...
module CSP.Examples.Cardano_network.FourNode.Liveness.LTL.Walk.WalkConvNodeDrop (blkA : Block₃) where
...
open import CSP.Examples.Cardano_network.FourNode.Liveness.LTL.Walk.WalkConvNodeWt blkA
  using ( bundleWt

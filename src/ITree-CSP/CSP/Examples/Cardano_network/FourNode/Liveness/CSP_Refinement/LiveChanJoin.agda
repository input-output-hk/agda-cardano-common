...
module HopArm
  ...
  chanH-api l s s′ (store l₀ d₀ id₀) v medEq seq ceq iv = api-frame l s s′ medEq seq ceq iv
  chanH-api l s s′ (env l₀ d₀ id₀) v medEq seq ceq iv = api-frame l s s′ medEq seq ceq iv

...
module CSP.Examples.Cardano_network.FourNode.Liveness.R2_Bisim.SysOracle_PeerEvIo (blkA : Block₃) where
...
open import CSP.Examples.Cardano_network.FourNode.Liveness.R2_Bisim.SysOracle_PeerEvCSBF blkA public

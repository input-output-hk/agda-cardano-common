...
`BlockLiveness⁺` of `FourNodeDiamondLiveness.lagda.md`. The reading is: *if at
...
module CSP.Examples.Cardano_network.FourNode.FourNodeDiamondLivenessCSP where
```
...
-- sanity: instantiating at b1 recovers the shipped system (nodeA = nodeAOf b1)
_ : systemBrokenOf b1 ≡ systemBroken
_ = refl

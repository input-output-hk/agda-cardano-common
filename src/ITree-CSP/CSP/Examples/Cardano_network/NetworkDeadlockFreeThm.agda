...
module CSP.Examples.Cardano_network.NetworkDeadlockFreeThm
  (Data : Set) ⦃ _ : DecEq Data ⦄ (d₀ : Data) where

-- Bring in `p1` from the Gen module (the fixed single-channel instance).
open import CSP.Examples.Cardano_network.NetworkRefinementGen Data using (p1)
...
open import CSP.Examples.Cardano_network.NetworkDeadlockFree p1 Data d₀
